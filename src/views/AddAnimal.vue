                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form @submit.prevent="submitForm" class="space-y-4 md:space-y-6" action="#">
                        <div>
                            ...
                            <input type="text" v-model="AnimalName" name="AnimalName" id="AnimalName" placeholder="Example: Jenny the Squirrel Monkey" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500" required>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="">
                                <label for="ParentMaleName" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ParentMaleName</label>
                        ...
                        <button type="submit" class="w-full text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Add animal</button>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    ...
    methods: {
        async submitForm() {
            try {
                const response = await fetch('http://localhost:7106/api/AnimalRecords/create', {
                    method: 'POST',
                    headers: {
                    ...
                    body: JSON.stringify({
                        ...
                        FeedingInformations: this.FeedingInformations,
                ...
                if (response.ok) {
                    ...
                    this.ParentMaleName = '';
                    this.ParentMaleId = '1';
                    this.ParentFemaleName = '';
                    this.ParentFemaleId = '2';
                    this.Area = '';
                    this.Enclosure = '';
                    this.FeedingData = [];
                    this.FeedingInformations = [];
                    this.VeterinaryRecords = [];
